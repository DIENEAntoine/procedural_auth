...
declare(strict_types=1);
            ...
            if (array_key_exists($input_name, $data_clean)) 
            {
                foreach ($rules as $rule) 
                {
                    foreach ($all_messages as $key_message => $message) 
                    {
                        ...
                        elseif (($rule === "string") && ($key_message === "$input_name.string")) 
                        {
                        ...
                        elseif ( (substr($rule, 0, 3) === "max") && ($key_message === "$input_name.max") ) 
                        {
                        ...
                        elseif ( (substr($rule, 0, 3) === "min") && ($key_message === "$input_name.min") ) 
                        {
                        ...
                        elseif ( ($rule === "email") && ($key_message === "$input_name.email") ) 
                        {
                        ...
                        elseif ( (substr($rule, 0, 6) === "unique") && ($key_message === "$input_name.unique") ) 
                        {
                        ...
                        elseif ( (substr($rule, 0, 5) === "regex") && ($key_message === "$input_name.regex") ) 
                        {
                        ...
                        elseif ( (substr($rule, 0, 4) === "same") && ($key_message === "$input_name.same") ) 
                        {
    ...
    /**
     * Cette fonction vérifie si la valeur envoyée par m'utilisateur 
     * respecte l'expression régulière prévue par le systéme.
     *
     * @param string $value
     * @param string $rule
     * 
    ...
    /**
     * Cette fonction vérifie si la valeur envoyée par m'utilisateur existe déjà
     * dans la table ciblée de la base de donnée ou non
     *
     * @param string $value
     * @param string $rule
     * 
    ...
    /**
     * Cette fonction permet de verifier si l'email envoyé par l'utilisateur
     * est valide ou non.
     *
     * @param string $value
     * 
    ...
    function email_($value) : bool
    {
       ...
       /**
     * Cette fonction vérifie si la valeur envoyé par l'utilisateur est inférieur 
     * ou non à celle prévue par le systèlme.
     *
     * @param string $value
     * @param string $rule
     * 
    ...
    /**
     * Cette fonction vérifie si la valeur envoyé par l'utilisateur est supérieur 
     * ou non à celle prévue par le systèlme.
     *
     * @param string $value
     * @param string $rule
    ...
    /**
     * Cette foncgtion vérifie si la valeur est de type chaine de caractères.
     *
     * @param string $value
     * 
     * @return boolean
    ...
    /**
     * Cette fonction vérifie si la valeur de l'input existe et qu"ll" n'est pas vide
     *
     * @param string $value
     * @return boolean
     */
    ...
    /**
     * Cette function protège le serveur contre de l'injection de code sous forme de scripts malveiullants
     *
     * @param array $data
     * @return void
     */
