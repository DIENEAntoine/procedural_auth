<?php
    ...
    /**
     * Cette function permet d'afficher le premier massage d'erreur de l'input
     * dont on lui passe le nomen paramètre.
     *
    ...
    /**
     * Cette fonction prend le nom d'un l'input en paramètre et retourne la valeur qui lui est associée.
     *
     * @param string $input_name
     * @return string|null 
     */
